...
public class ExtendsExam {
	...
	public static void main(String[] args) {
		...
		String str = c1.getName(); // Parent Class
		System.out.println("c1.getName() : " + str); 
		
		System.out.println("------------------------------");
		c1.setName("자식이 보낸 이름(this 있음)");
		System.out.println(c1.name); // 자식 클래스의 name | Child Class
		...
		System.out.println("------------------------------");
		c1.printName(); // 자식 클래스와 부모 클래스의 name 출력 | Child Class
	}
